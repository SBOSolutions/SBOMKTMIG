{
    ...
    'summary': 'barcode product ean13 barcode product auto barcode ean13 barcode Restrict Read Only User Hide Any Menu Restrict User Menus multi level approve three level approve Project Checklist Task Checklist website document attachment product attachment',
    'description': """
